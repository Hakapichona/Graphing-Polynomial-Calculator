...
def graficarA():
    ...
    plt.xlim(mx - d, mx + d)
    plt.ylim(my - d, my + d)
    mensajeResultado.configure(text="Punto Medio: ("+str(mx)+", "+str(my)+")")
...
def graficarC():  # Problemas pendientes
    ...
    plt.ylim(y2 - (distancia * 6), y2 + (distancia * 6))
...
def graficarD():
    ...
    mensajeResultado.configure(text="Ecuacion de la recta: " + str(-m)+"x "+"+ y +"+str(m*x1-y1)+" = 0")
    mensajeResultado.grid(column=4, row=5, padx=5, pady=5)
    canvas.get_tk_widget().grid(column=4, row=6, padx=5, pady=5)
    guardar.grid(column=4, row=7, padx=5, pady=5)
    limpiar.grid(column=4, row=8, padx=5, pady=5)
...
def graficarF():
    ...
    mensajeResultado.configure(text="Ecuacion de la recta: " + str(-m) + "x " + "+ y +" + str(m * x2 - y2) + " = 0")
    mensajeResultado.grid(column=4, row=5, padx=5, pady=5)
    canvas.get_tk_widget().grid(column=4, row=6, padx=5, pady=5)
    guardar.grid(column=4, row=7, padx=5, pady=5)
    limpiar.grid(column=4, row=8, padx=5, pady=5)
...
def graficarH():  # hecho
    ...
    plt.plot(x, y, 'g:')
    plt.plot(h, k, 'rx')
    mensajeResultado.configure(text="Ecuacion de la circunferencia: "+"x2 "+"+ y2 +"+str(-h*2)+"x +"+str(-k*2)+"y +"+\
        str(h**2+k**2-ratio**2)+" = 0")
    mensajeResultado.grid(column=4, row=5, padx=5, pady=5)
    canvas.get_tk_widget().grid(column=4, row=6, padx=5, pady=5)
    guardar.grid(column=4, row=7, padx=5, pady=5)
    limpiar.grid(column=4, row=8, padx=5, pady=5)
